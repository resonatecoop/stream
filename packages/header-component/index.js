...
const ThemeSwitcher = require('@resonate/theme-switcher-component')
const AddCredits = require('@resonate/topup-credits-component')
const link = require('@resonate/link-element')
const imagePlaceholder = require('@resonate/svg-image-placeholder')
const matchMedia = require('@resonate/match-media')
