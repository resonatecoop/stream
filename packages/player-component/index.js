...
class Player extends Nanocomponent {
  ...
  renderPlayer () {
    ...
    let infoBar = ''
    if (!isAuthenticated) {
      infoBar = html`<a class=${classesInfoBar} href="https://stream.resonate.coop/api/v3/user/connect/resonate" target="_blank" rel="noopener noreferer">Log in to listen to full song</a>`
